...
::: callout-tip
Les macros Stata sont reconnues dans un code Python et appelées de la même façon. C'est très intéressant.
:::
...
* La majeure partie des graphiques sont générés avec la librairie `plotnine` qui est un wrapper de ggplot2 sous python. La logique de la syntaxe est assez particulière, et l'objet de cette présentation n'est pas de la présentée. La programmation des graphiques avec ggplot est très documentée et on reverra vers: 
  * le Support **plotnine** (fonctions peu détaillées): <https://plotnine.readthedocs.io/en/stable/index.html> 
  * la traduction des chapitres de l'ouvrage *[R for data science](https://r4ds.had.co.nz/)* (H.Wickham,G.Grolemund) dédiés à **ggplot** en **plotnine**:<https://datascienceworkshops.com/blog/plotnine-grammar-of-graphics-for-python/>
